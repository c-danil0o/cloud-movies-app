...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, InputTextModule, SelectButtonModule, DropdownModule, FileUploadModule, ProgressSpinnerModule],
  templateUrl: './add-movie.component.html',
  styleUrl: './add-movie.component.css'
})
export class AddMovieComponent {
  constructor(private router: Router, private messageService: MessageService, private movieService: MovieService) {
  ...
  fileSize: number = 0
    ...
    if (this.movieName != "" && !isNaN(Number(this.year)) && this.director != "" && this.genre != null && this.description != "" && this.actors != "" && !isNaN(Number(this.rating)) && !isNaN(Number(this.duration)) && this.movie != null) {
